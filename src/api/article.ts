...
// 게시글 등록하기
export const createArticleClient = async (articleData: {
  image: string[];
  content: string;
  title: string;
}) => {
...
export const getArticleComments = async (
  ...
  try {
    const response = await axiosInstance.get<ArticleCommentResponse>(
...
export const createArticleComment = async (
  ...
  try {
    await axiosInstance.post(`/articles/${articleId}/comments`, { content });
  } catch (error) {

...
import BestArticles from '@/components/UI/community/BestArticles';
import AllArticles from '@/components/UI/community/AllArticles';
  ...
  return (
    <div className='container mx-auto px-4 py-8 mt-12'>
      ...
      <div className='flex flex-col mt-8 mb-4'>
        <h1 className='text-2xl font-bold mb-4'>전체 게시글</h1>

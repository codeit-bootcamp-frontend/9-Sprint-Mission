...
// 상품 상세 보기
export const getDetailItem = async (productId: string) => {
  try {
...
// 상품 댓글 조회하기
export const getProductsComments = async (productId: string) => {
  try {
    // const query = new URLSearchParams(params).toString();
...
// 상품 댓글 등록하기
export const postProductsComments = async (
  productId: string,
  content: string
) => {
...
// 상품 댓글 수정하기
export const patchProductsComments = async (
  productId: string,
  id: number,
  content: string
) => {
